...
build conversations. Reads from `.planning/spikes/`, writes skill to `./.cursor/skills/spike-findings-[project]/`
...
- [ ] Spike-findings skill exists at `./.cursor/skills/` with SKILL.md, references/, sources/
