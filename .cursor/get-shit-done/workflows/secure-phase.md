...
```
Task(
  prompt="Read /Users/vishvah/Documents/GitHub/HoopProphet/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/vishvah/Documents/GitHub/HoopProphet/.cursor/get-shit-done/templates/SECURITY.md`
