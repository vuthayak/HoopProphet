...
```bash
node "/Users/vishvah/Documents/GitHub/HoopProphet/.cursor/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/vishvah/Documents/GitHub/HoopProphet/.cursor/get-shit-done/templates/retrospective.md`.
