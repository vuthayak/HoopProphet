...
```bash
INIT=$(node "/Users/vishvah/Documents/GitHub/HoopProphet/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/vishvah/Documents/GitHub/HoopProphet/.opencode/get-shit-done/templates/spec.md.
