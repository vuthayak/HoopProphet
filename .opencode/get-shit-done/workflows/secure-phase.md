...
```
Task(
  prompt="Read /Users/vishvah/Documents/GitHub/HoopProphet/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/vishvah/Documents/GitHub/HoopProphet/.opencode/get-shit-done/templates/SECURITY.md`
