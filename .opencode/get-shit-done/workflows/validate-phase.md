...
```
Task(
  prompt="Read /Users/vishvah/Documents/GitHub/HoopProphet/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/vishvah/Documents/GitHub/HoopProphet/.opencode/get-shit-done/templates/VALIDATION.md`
